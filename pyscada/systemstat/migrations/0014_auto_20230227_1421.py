            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        choices=[(0, "local"), (1, "remote (ssh)")],
                        default=0,
                        help_text="Choose the local system hosting PyScada or a remote system accessible by SSH",
                    ),
                ),
